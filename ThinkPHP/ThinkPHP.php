...
defined('CSS_PATH')  or define('CSS_PATH',    '/Public/css');   //CSS目录
defined('JS_PATH')  or define('JS_PATH',    '/Public/js');   //JS目录
defined('IMAGE_PATH')  or define('IMAGE_PATH',    '/Public/image');   //IMAGE目录
defined('ICON_PATH')  or define('ICON_PATH',    '/Public/icon');   //ICON目录
defined('FONT_PATH')  or define('FONT_PATH',    '/Public/font/css');   //ICON目录
